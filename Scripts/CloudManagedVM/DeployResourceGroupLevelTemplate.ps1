...
Param(
    ...
    [Parameter(Mandatory=$True)]
    [ValidateNotNullOrEmpty()]
    # Linked resource group name
    [string]$linkedResourceGroup
)
...
$client.DeployTemplateAtResourceGroupLevel($saasResourceGroup, $deviceName, $templateFilePath, $templateParamsFilePath, $linkedResourceGroup)
